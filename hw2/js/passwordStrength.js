    ...
    prototype: {
        init: function (ele, settings) {
            var eleName = ele.attr('name'),
                ...
                progress = '<div class="form-column form-column--progress-line"><span class="form-column__name">Надежность пароля</span><div class="password-progress form-column__value"><div data-name="' + eleName + '" class="progress-bar" style="width: 0%;"></div></div></div>',
                $progress;
            $('.form-column--progress').after(progress);
